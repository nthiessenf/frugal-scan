    ...
    <section className="w-full pt-4 md:pt-8 pb-16 md:pb-24 px-5">
      ...
      >
        ...
        <div className="relative">
          ...
          {/* Premium card */}
          <div
            className="relative rounded-3xl border border-black/[0.04] bg-white overflow-hidden shadow-[0_0_0_1px_rgba(0,0,0,0.03),0_2px_4px_rgba(0,0,0,0.04),0_12px_24px_rgba(0,0,0,0.06),0_32px_64px_rgba(0,0,0,0.06)]"
          >
            {/* Dashboard content */}
            ...
            {/* Pie chart + Insights side by side */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {/* Insights preview — colored left borders */}
              <div
                className="rounded-2xl bg-white border border-black/[0.06] p-4 shadow-[0_1px_3px_rgba(0,0,0,0.05)]"
                role="region"
                aria-label="Sample insights preview"
              >
                <h3 className="text-xs font-semibold text-[#1d1d1f] mb-2">Key Insights</h3>
                <ul className="space-y-2">
                  {previewInsights.map((insight, idx) => {
                    ...
                    return (
                      <li
                        key={insight.id}
                        className="flex gap-2 rounded-lg bg-white border border-black/[0.04] p-2.5 border-l-[3px]"
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[11px] text-[#6e6e73] line-clamp-2 mt-0.5">{descSnippet}</p>
                        </div>
                      </li>
                    );
                  })}
            ...
            <div className="mt-4 rounded-2xl bg-white border border-black/[0.06] p-4 shadow-[0_1px_3px_rgba(0,0,0,0.05)]">
